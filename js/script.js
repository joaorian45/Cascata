...
function atualizarTextos(numeroImagem) {
  ...
  var textosEsquerda = ["", "Ana <span> cortava legumes </span> em sua cozinha, <span style='color: red;'>quando derrepente...</span>.", "Cortou seu dedo", "Houve o rompimento do endotélio", "As hemácias estão saindo... ", "", "", "", "", ""];
